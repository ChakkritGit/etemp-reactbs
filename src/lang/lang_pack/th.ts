...
export default {
  translation: {
    ...
    login_button_loading: 'กำลังเข้าสู่ระบบ',
    // sweetalert
    alert_header_Warning: 'คำเตือน',
    alert_header_Error: 'ผิดพลาด',
    alert_header_Success: 'สำเร็จ',
    complete_field: 'โปรดป้อนข้อมูลให้ครบ',
